-- ROYJETDO ULTIMATE (SUPER KILL AURA - GOD MODE - FULL ESP)
...
Title.Text = "Royjetdo" -- Tên script mới của bạn
...
local function CreateESP(targetPlayer)
    ...
    RunService.RenderStepped:Connect(function()
        if _G.Settings.ESP and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") and targetPlayer.Character.Humanoid.Health > 0 then
