-- XuanAnhpvp - ULTIMATE EDITION
-- Name: XuanAnhpvp
-- Features: Fly, God Mode, ESP, Aimlock, Speed, Jump, Hitbox Slider
...
ScreenGui.Name = "XuanAnhhub_Official"
...
Main.BorderColor3 = Color3.fromRGB(0, 191, 255) -- Sky Blue
Main.Active = true
Main.Draggable = true
...
Title.Text = "XuanAnhhub GUI"
Title.BackgroundColor3 = Color3.fromRGB(255, 180, 200) -- Cherry Pink
    ...
    for _, v in pairs(game.Players:GetPlayers()) do
        if v ~= player and v.Character then
            if state then
                ...
                h.Name = "XA_ESP"; h.FillColor = Color3.fromRGB(255, 180, 200)
            else
                if v.Character:FindFirstChild("XA_ESP") then v.Character.XA_ESP:Destroy() end
            end
        end
    end
end)
...
local aimOn = false
CreateToggle("Aimlock", function(v) aimOn = v end)
...
-- 4. Sliders
CreateSlider("Fly Speed", 50, 300, 50, function(v) flySpeed = v end)
