...
Title.Text = "HUHU HUB PREMIUM V4.2"
...
for i = 1, MAX_PORTALS do
    ...
    delBtn.Size = UDim2.new(0, 48, 0, 20)
    delBtn.Position = UDim2.new(0, (i - 1) * 52, 0, 36)
    ...
    delCorner.CornerRadius = UDim2.new(0, 4)
...
-- Nút xóa toàn bộ cổng (Clear All)
local clearAllBtn = Instance.new("TextButton", PortalContainer)
clearAllBtn.Size = UDim2.new(1, -10, 0, 30)
clearAllBtn.Position = UDim2.new(0, 5, 0, 65)
clearAllBtn.BackgroundColor3 = Color3.fromRGB(100, 30, 30)
clearAllBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
clearAllBtn.Text = "❌ XÓA TẤT CẢ CỔNG"
clearAllBtn.Font = Enum.Font.SourceSansBold
clearAllBtn.TextSize = 14

Instance.new("UICorner", clearAllBtn).CornerRadius = UDim2.new(0, 6)
